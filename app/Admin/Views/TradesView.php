...
class TradesView extends LazyRenderable
{
    ...
    public function grid(): Grid
    {
        ...
        $grid->column('stoploss', __('mt4-account.stoploss'));
        $grid->column('takeprofit', __('mt4-account.takeprofit'));
        $grid->column('commission', __('mt4-account.commission'));
