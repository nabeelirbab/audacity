...
class StrategyController extends AdminController
{
    ...
    protected function detail($id)
    {
        ...
        $show->relation('orders', ___('orders'), function (Strategy $strategy) {

            return new Grid($strategy->orders()->getQuery(), function (Grid $grid) {
    ...
    protected function form()
    {
        return new Form(new Strategy(), function (Form $form) {
            ...
            $form->file('file_name', 'File')->options($options)->required()->autoUpload();
            ...
            $form->saved(function (Form $form) {
                ...
                $data = $storage->get($form->file_name);

                $account = $this->_process_html($form->model()->id, $form->model()->name, $data);
