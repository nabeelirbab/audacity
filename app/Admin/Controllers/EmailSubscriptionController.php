...
class EmailSubscriptionController extends AdminController
{
    ...
    protected function form()
    {
        return new Form(new EmailSubscription(), function (Form $form) {
            ...
            $form->editor('template_signal_new', 'Template order "New"')
...
<b>Entry Price:</b> {{ $price }} @ (<b>Entry Time:</b> {{ $time_open }} )')
            ...
            $form->button('Test "New"')->on('click', $this->formatClick($form, 'new'));

            $form->editor('template_signal_updated', 'Template order "Modify"')->
...
<b>TakeProfit:</b> {{ $takeprofit }}<br>')->
            ...
            $form->button('Test "Updated"')->on('click', $this->formatClick($form, 'updated'));

            $form->editor('template_signal_closed', 'Template order "Close"')->
...
<b>Pips:</b> {{ $pips }}')->
            ...
            $form->button('Test "Closed"')->on('click', $this->formatClick($form, 'closed'));
