...
//        $user = User::withCount('accounts')->find(Admin::user()->id);
        ...
        //         $row->column(3, (new UsersOverviewInfoBox)->padding('15px'));
        //         $row->column(3, (new AccountsOverviewInfoBox)->padding('15px'));
        //         $row->column(3, (new SystemLogsOverviewInfoBox)->padding('15px'));
        //         $row->column(3, (new ReportOverviewInfoBox)->padding('15px'));
        //     });

        //     $content->row(function ($row) {
        //         $row->column(3, (new SignalsOverviewInfoBox)->padding('15px'));
    ...
    protected function gridManagerOrdersNotFilled()
    {
        return new Grid( new Order(), function (Grid $grid) {
            ...
            $grid->account()->account_status('Status')->enum();
