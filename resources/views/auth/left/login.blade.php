            ...
            <div class="login-box">
                ...
                <div class="card">
                    <div class="card-body login-card-body">
                        ...
                        @if(config('admin.allow-register')) <p class="text-center">I'm new here - click <a href="/register">here</a> to register</p> @endif
                        @if(config('admin.allow-reset-password'))<p class="mt-1 mb-1 text-center">Forgot password - click <a href="{{ admin_url('reset-password') }}">here</a></p>@endif
                        <p class="mt-1 mb-1 text-center">
                            <img src="/storage/img/login-bottom.png">
                        </p>
                    </div>
                </div>
            </div>
